...
const linkIcon = (
  <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M16 1L1 16" stroke="var(--green-color)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M2.5 1H16V14.5" stroke="var(--green-color)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
...
const githubIcon = (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      stroke="var(--green-color)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
